...
namespace Hotel
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration.GetConnectionString("Test01Connection"));
            });
            ...
            services.AddAuthentication(Constantes.Identity.Auth).AddCookie(Constantes.Identity.Auth, o =>
            {
                o.Cookie.Name = Constantes.Identity.Auth;
                o.LoginPath = "/Login";
